...
rule generate_library_adt:
    ...
    threads:
        config['tools']['generate_library_adt']['threads']
    benchmark:
...
rule cellranger_count_adt:
    ...
    output:
        zipped_features_file = CELLRANGER_ADT_OUT + '{sample}/outs/filtered_feature_bc_matrix/features.tsv.gz', 
        zipped_barcodes_file = CELLRANGER_ADT_OUT + '{sample}/outs/filtered_feature_bc_matrix/barcodes.tsv.gz',
        zipped_matrix_file = CELLRANGER_ADT_OUT + '{sample}/outs/filtered_feature_bc_matrix/matrix.mtx.gz',
        ...
        web_file = report(CELLRANGER_ADT_OUT + '{sample}.web_summary.html', caption="../report/cellranger_adt.rst", category="preprocessing QC"),
    ...
    threads:
        config['tools']['cellranger_count_adt']['threads']
    benchmark:
...
rule create_symlink_adt:
    ...
    output:
        ...
        features_file = ROOTDIR + '{sample}/analysis_pooledSample/cellranger_adt/{sample}.features.tsv',
        matrix_file = ROOTDIR + '{sample}/analysis_pooledSample/cellranger_adt/{sample}.matrix.mtx',
        barcodes_file = ROOTDIR + '{sample}/analysis_pooledSample/cellranger_adt/{sample}.barcodes.tsv',
        web_summary = ROOTDIR + '{sample}/analysis_pooledSample/cellranger_adt/{sample}.web_summary.html',
        metrics_summary = ROOTDIR + '{sample}/analysis_pooledSample/cellranger_adt/{sample}.metrics_summary.csv'
    params:
...
rule create_symlink_adt_nonHashed:
    ...
    output:
        ...
        # NOTE: here, a fixed structure is assumed for the analysis directory
        features_file = ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/{sample}.features.tsv',
        matrix_file = ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/{sample}.matrix.mtx',
        barcodes_file = ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/{sample}.barcodes.tsv',
        web_summary = ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/{sample}.web_summary.html',
        metrics_summary = ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/{sample}.metrics_summary.csv',
        zipped_features_file = ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/{sample}/outs/filtered_feature_bc_matrix/features.tsv.gz',
        zipped_matrix_file = ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/{sample}/outs/filtered_feature_bc_matrix/matrix.tsv.gz',
        zipped_barcodes_file = ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/{sample}/outs/filtered_feature_bc_matrix/barcodes.tsv.gz' 
    params:
        root_out = ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/',
        lsfoutfile = ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/{sample}.create_symlink_adt_nonHashed.lsfout.log',
        lsferrfile = ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/{sample}.create_symlink_adt_nonHashed.lsferr.log',
        scratch = config['tools']['create_symlink']['scratch'],
        mem = config['tools']['create_symlink']['mem'],
        time = config['tools']['create_symlink']['time']
    threads:
        config['tools']['create_symlink']['threads']
    benchmark:
        ROOTDIR + '{sample}/analysis_{sample}/analysis/cellranger_run_adt/{sample}.create_symlink_adt_nonHashed.benchmark'
    shell:
