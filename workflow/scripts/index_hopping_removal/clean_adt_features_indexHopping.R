...
## Correct type of feature for ADT data See:
# https://support.10xgenomics.com/single-cell-gene-expression/software/pipelines/latest/output/matrices
# "The third column identifies the type of feature, which will be one of
# Gene Expression, Antibody Capture, CRISPR, or CUSTOM, depending on the feature type."
